        ...
        <div class="fsb-container">
            ...
            <div class="trip-type-row">
                <label class="trip-radio">
                    <input type="radio" name="rental" value="round-trip" checked>
                    <span>Round Trip</span>
                </label>

                <label class="trip-radio">
                    <input type="radio" name="rental" value="one-way">
                    <span>One Way</span>
                </label>
            </div>
            ...
            <div class="search-inputs-row">
                ...
                <div class="si-field traveler-field">
                    <i class="fa-solid fa-car" style="color:#1a73e8;"></i>

                    <div class="select-wrapper">
                        <select name="vehicle_type" aria-label="Vehicle type">
                ...
                <!-- Search Button -->
                <button type="button" class="btn-search-flight">
            ...
            <!-- Search Note -->
            <div class="car-search-note">
                <i class="fa-solid fa-circle-info"></i>
                <span>
                    Compare available car rental options and choose the vehicle
